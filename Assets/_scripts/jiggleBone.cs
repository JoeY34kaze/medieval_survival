...
public class jiggleBone : MonoBehaviour
{
    ...
    public float max_angle_z = 1;
    // Dynamics settings
    public float bStiffness = 0.05f;
    ...
    public float sideStretch = 0.3f;
    public float frontStretch = 0.5f;
    ...
    void LateUpdate()
    {
        ...
        Vector3 forwardVector = transform.root.forward * targetDistance;
