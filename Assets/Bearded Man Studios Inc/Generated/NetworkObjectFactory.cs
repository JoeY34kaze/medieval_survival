			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case NetworkCameraNetworkObject.IDENTITY:
						...
						break;
					case NetworkContainerItemsNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new NetworkContainerItemsNetworkObject(networker, id, frame);
						break;
					case NetworkContainerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new NetworkContainerNetworkObject(networker, id, frame);
						break;
					case NetworkCraftingStationNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new NetworkCraftingStationNetworkObject(networker, id, frame);
						break;
					case NetworkedSiegeProjectileNetworkObject.IDENTITY:
						availableCallback = true;
