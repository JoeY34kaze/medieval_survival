...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class NetworkPlayerMovementBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (NetworkPlayerMovementNetworkObject)obj;
		...
		{
			Initialize(new NetworkPlayerMovementNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new NetworkPlayerMovementNetworkObject(networker, this, createCode, metadata);
		}
