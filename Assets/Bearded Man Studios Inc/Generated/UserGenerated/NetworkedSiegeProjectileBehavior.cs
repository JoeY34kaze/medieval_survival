...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class NetworkedSiegeProjectileBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (NetworkedSiegeProjectileNetworkObject)obj;
		...
		{
			Initialize(new NetworkedSiegeProjectileNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new NetworkedSiegeProjectileNetworkObject(networker, this, createCode, metadata);
		}
		...
		/// Vector3 position
		/// </summary>
		public abstract void sendHitToClients(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// </summary>
