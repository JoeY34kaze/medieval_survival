...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class NetworkPlayerAnimationBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (NetworkPlayerAnimationNetworkObject)obj;
			networkObject.AttachedBehavior = this;

			base.SetupHelperRpcs(networkObject);
			networkObject.RegisterRpc("NetworkMovementAnimationUpdate", NetworkMovementAnimationUpdate, typeof(float), typeof(float));
		...
		{
			Initialize(new NetworkPlayerAnimationNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new NetworkPlayerAnimationNetworkObject(networker, this, createCode, metadata);
		}
		...
		/// float horizontal
		/// </summary>
		public abstract void NetworkMovementAnimationUpdate(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// bool status
		/// </summary>
		public abstract void NetworkMovementAnimationCrouchedUpdate(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// </summary>
		public abstract void NetworkStartJumpRemote(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// </summary>
		...
		/// Arguments:
		/// </summary>
		public abstract void NetworkExecutionUpdate(RpcArgs args);
